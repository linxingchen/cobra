...
3. If none of the queries was extended, the process will abnormally exit, which has been fixed as well. If your run does not have the expected output files, check the log file.
